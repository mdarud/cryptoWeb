...
with open("yoyo.gif", mode='rb') as file:
    fileContent = file.read()
    z = ExVigenere.binencrypt(fileContent, "exVigenere")
    file.close()
...
with open("yoyo2.gif", mode='rb') as file:
    fileContent = file.read()
    z = ExVigenere.bindecrypt(fileContent, "exVigenere")
    file.close()
